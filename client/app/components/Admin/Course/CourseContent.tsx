...
const CourseContent: FC<Props> = ({
  ...
  const handleRemoveLine = (index: number, linkIndex: number) => {
  ...
  const newContainerHandler = (item: any) => {
    if (
      item.title === "" ||
      item.description === "" ||
      item.videoUrl === "" ||
      ...
      toast.error("Please Fill All the Fieled First");
    } else {
      let newVideoSection = "";
      if (courseContentData.length > 0) {
        const lastVideoSection =
          courseContentData[courseContentData.length - 1].videoSection;
        //   use the las video section if available else use user input
        if (lastVideoSection) {
  ...
  const handleOptions = () => {
    if (
      ...
      toast.error("Section Can't be Empty Fill It First");
    } else {
      setActive(active + 1);
      handleCourseSubmit();
    }
            ...
            <>
              ...
              >
                ...
                <div className="flex w-full items-center justify-between my-0">
                  ...
                  {/* Arrrow button for collapsed video content */}
                        ...
                        <div className=" w-full flex items-center justify-between ">
                          ...
                          <AiOutlineDelete
                            ...
                            onClick={() =>
                              linkIndex === 0
                                ? null
                                : handleRemoveLine(index, linkIndex)
                            }
                          />
                        </div>
                        <input
                ...
                {index === courseContentData.length - 1 && (
                  <div className="">
                    <p
                      className="flex items-center text-[18px] dark:text-white text-black cursor-pointer"
                      onClick={(e: any) => newContainerHandler(item)}
                    >
