      ...
      <div className="w-full flex flex-col-reverse 800px:flex-row">
        ...
        <div className=" sticky top-[100px] left-0 z-50 w-full">
            ...
            <div className="flex items-center">
                {
                    isPurchased ? (
                        <Link href={`/course-access/${data?._id}`} className={`${styles.button} !w-[180px] font-Poppins cursor-pointer `}> Enter to Course</Link>
                    ):(
                        <button onClick={handleOrder} className={`${styles.button} !w-[180px] font-Poppins`}> Buy Now {data?.price} $</button>
                    )
                }
            </div>
            <br />
