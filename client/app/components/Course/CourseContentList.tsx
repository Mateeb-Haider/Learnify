...
const CourseContentList: FC<Props> = (props) => {
  ...
  const toggleSction = (section: string) => {
  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        const sectionStartIndex: number = totalCount; // Starting index for videos in this section
            ...
            {isSectionVisible && (
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  const videoIndex: number = sectionStartIndex + index; // Calculate the actual index in the full video list
